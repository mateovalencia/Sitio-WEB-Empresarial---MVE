function responsiveMobileMenu() {
	$('.nav').each(function() {
		...
		if (typeof $style == 'undefined' || $style == false) {
			$(this).addClass('pasteleria'); // set pasteleria style if style is not defined
		} else {
			$(this).addClass($style);
		}
...
$(document).ready(function() {
	...
	var $submenus = $('.nav.pasteleria .nav-menu li > ul');
	$submenus.hide();
	...
	var $submenusSm = $('.nav.pasteleria .nav-toggled li > ul');
	$submenusSm.hide();
